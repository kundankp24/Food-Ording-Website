        ...
        <Card>
            <CardHeader>
                <CardTitle className="grid md:grid-cols-4 gap-4 justify-between mb-3">
                    ...
                    <div>
                        Delivery address:
                        <span className="font-normal ml-2">{order.deliveryDetails.addressLine1}, {order.deliveryDetails.city}</span>
                    </div>
                    <div>
                        Time:
                    ...
                    <div>
                        Total:
                        <span className="font-normal ml-2">£{(order.totalAmount/100).toFixed(2)}</span>
                    </div>
                </CardTitle>
                <Separator/>
            </CardHeader>
